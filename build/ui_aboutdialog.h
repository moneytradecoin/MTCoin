...
"Copyright &copy; 2011-YYYY The MoneyTradeCoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MoneyTradeCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>MoneyTradeCoin</b> version", 0));
